...
m<- read.csv("../tmp/myligne.csv") # myligne.csv est un fichier intérmediaire génerer par shiny selon la sélection de l'utilisateur (voir fichier server.R et ui.R)
